 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
	...
	V.push([
		...
		function (a) {
			...
			if ((b = a.u))
				(a = M(R, 'us', [])), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push('http:' + b[1]);
		}
	]);
	var Pa = /^(\/[a-zA-Z0-9_\-]+)+$/,
		Qa = [/\/amp\//, /\/amp$/, /^\/amp$/],
		...
		Xa = function (a, b, c, d, e) {
			...
			b = l;
			c = b.match(Ua);
			((d = b.match(Va)) && 1 === d.length && Wa.test(b) && c && 1 === c.length) ||
				W('failed sanity: ' + a);
			try {
				a = '?';
				if (e && 0 < e.length) {
					...
					for (d = {}; c < e.length; ) {
						...
						f =
							('object' == k && null != q) || 'function' == k
								? 'o' +
								  ((Object.prototype.hasOwnProperty.call(q, p) && q[p]) || (q[p] = ++ka))
								: (typeof q).charAt(0) + q;
			...
			return void 0 !== a
				...
				? (a = L.querySelector('script[nonce]'))
					? ((a = a.nonce || a.getAttribute('nonce') || ''),
					  a && a === String(a) && a.match(ab) ? (R.nonce = a) : (R.nonce = null))
					: null
				: null;
		},
		eb = function (a) {
