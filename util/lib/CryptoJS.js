!(function (t, e) {
	...
	return (
		...
		(M.WordArray = n.extend({
			...
			clone: function () {
				for (
					var t = n.clone.call(this), e = (t.words = this.words.slice(0)), r = e.length, i = 0;
					i < r;
					i++
				)
					e[i] = e[i].clone();
			...
			e = e.SHA3 = i.extend({
				...
				_doFinalize: function () {
					...
					(e[r >>> 5] |= 1 << (24 - (r % 32))),
						...
						this._process();
					for (
						var n = this._state, e = this.cfg.outputLength / 8, o = e / 8, s = [], c = 0;
						c < o;
						c++
					) {
						var a = n[c],
		...
		(S = u.create([
			...
			2, 14, 11, 8, 3, 10, 14, 4, 9, 15, 8, 1, 2, 7, 0, 6, 13, 11, 5, 12, 1, 9, 11, 10, 0, 8, 12,
			...
			!(function () {
				...
				for (var r = 0, i = 0, e = 0; e < 256; e++) {
					...
					(f[r] = (a << 24) | (a >>> 8)),
						...
						(p[r] = a),
						(_[n] =
							((a = (16843009 * c) ^ (65537 * s) ^ (257 * o) ^ (16843008 * r)) << 24) |
							(a >>> 8)),
						(y[n] = (a << 16) | (a >>> 16)),
						(v[n] = (a << 8) | (a >>> 24)),
						(g[n] = a),
